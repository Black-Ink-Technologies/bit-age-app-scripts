"use strict";var IdentityVerificationCDN=(()=>{var B=Object.defineProperty;var b=Object.getOwnPropertySymbols;var $=Object.prototype.hasOwnProperty,F=Object.prototype.propertyIsEnumerable;var _=(e,n,t)=>n in e?B(e,n,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[n]=t,A=(e,n)=>{for(var t in n||(n={}))$.call(n,t)&&_(e,t,n[t]);if(b)for(var t of b(n))F.call(n,t)&&_(e,t,n[t]);return e};var d=(e,n,t)=>new Promise((o,r)=>{var a=l=>{try{p(t.next(l))}catch(L){r(L)}},i=l=>{try{p(t.throw(l))}catch(L){r(L)}},p=l=>l.done?o(l.value):Promise.resolve(l.value).then(a,i);p((t=t.apply(e,n)).next())});var h="https://staging-api.chainit.online",C="/rule-engine/v1/age-app-embed/generate-qr",N="/rule-engine/v1/age-app-embed/get-qr",O="/public-api/v1/embed/validate",I="x-sign-key",M="x-organization-id",U={"Content-Type":"application/json"},q={AGE_APP:"age_app",CHECK_IN:"check_in"},v="#embed-qr-code",f="#embed-qr-code-logs",G=1500,E=5e3,s={WaitingForScan:"WaitingForScan",Timeout:"Timeout",Scanned:"Scanned",Approved:"Approved",RejectedByUser:"RejectedByUser",RejectedByRequirement:"RejectedByRequirement",SomethingWentWrong:"SomethingWentWrong"};var D=e=>({Timeout:`
